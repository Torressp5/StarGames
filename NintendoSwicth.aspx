<%@ Page Title="" Language="C#" MasterPageFile="~/Defaut.Master" AutoEventWireup="true" CodeBehind="NintendoSwicth.aspx.cs" Inherits="StarGame.Sitee.Plataforma" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="Image/Banners/bannerNintendo_01.png" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="Image/Banners/bannerNintendo_02.png" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="Image/Banners/bannerNintendo_03.png" alt="Third slide">
                </div>
            </div>
    ...
    <div class="container Colors">
          ...
          <nav>
            <ol class="breadcrumb Colors">
                ...
                <li class="breadcrumb-item active" aria-current="page">Nintendo Switch</li>
            </ol>
        </nav>
        <h1 class="text-light font-weight-light" style="font-size: 60px">Nintendo Switch</h1>
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
                    <img class="d-block w-100" src="Image/Banners/Mario-Odyssey.png" alt="First slide">
        </div>
    </div>
