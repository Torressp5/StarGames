<%@ Page Title="" Language="C#" MasterPageFile="~/Defaut.Master" AutoEventWireup="true" CodeBehind="Playstation5.aspx.cs" Inherits="StarGame.Sitee.Playstation5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <!--Carrosel-->
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="Image/Banners/banner-ps5_01.png" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="Image/Banners/banner-ps5_02.png" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="Image/Banners/banner-ps5_03.png" alt="Third slide">
                </div>
            </div>
    ...
    <hr />
        ...
        <h1 class="text-light font-weight-light" style="font-size: 60px">Playstation 5</h1>
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
                    <img class="d-block w-100" src="Image/Banners/ps5BANNER.png" alt="First slide">
        </div>
    </div>
